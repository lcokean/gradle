...
class ExecuteTaskUponEclipseModelLoadingCrossVersionSpec extends ToolingApiSpecification {
    def setup() {
        file("sub1").mkdirs()
    ...
    def "can set project task for synchronization"() {
        setup:
        buildFile << "eclipse { synchronizationTasks ':sub:bar' }"
    ...
    def "can set task selector for synchronization"() {
        setup:
